...
if("FALSE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX /home/tim/catkin_ws/src/ros_comm/tools/rosgraph)
  set(rosgraph_DEVEL_PREFIX /home/tim/catkin_ws/devel)
  set(rosgraph_INSTALL_PREFIX "")
  set(rosgraph_PREFIX ${rosgraph_DEVEL_PREFIX})
else()
  set(rosgraph_SOURCE_PREFIX "")
  set(rosgraph_DEVEL_PREFIX "")
  set(rosgraph_INSTALL_PREFIX /home/tim/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tim/catkin_ws/install/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
