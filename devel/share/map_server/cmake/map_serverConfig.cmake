...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/tim/catkin_ws/src/navigation/map_server)
  set(map_server_DEVEL_PREFIX /home/tim/catkin_ws/devel)
  ...
  set(map_server_INSTALL_PREFIX /home/tim/catkin_ws/install)
...
if(NOT "/home/tim/catkin_ws/src/navigation/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/tim/catkin_ws/src/navigation/map_server/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tim/catkin_ws/src/navigation/map_server/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
