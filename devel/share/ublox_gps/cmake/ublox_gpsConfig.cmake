...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/tim/catkin_ws/src/ublox/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/tim/catkin_ws/devel)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/tim/catkin_ws/install)
...
if(NOT "/home/tim/catkin_ws/src/ublox/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/tim/catkin_ws/src/ublox/ublox_gps/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tim/catkin_ws/src/ublox/ublox_gps/${idir}'.  Ask the maintainer 'Gareth Cross <gcross.code@icloud.com>, Chao Qu <quchao@seas.upenn.edu>' to fix it.")
    endif()
