...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /home/tim/catkin_ws/src/ros_comm/tools/rosbag)
  set(rosbag_DEVEL_PREFIX /home/tim/catkin_ws/devel)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /home/tim/catkin_ws/install)
...
if(NOT "/home/tim/catkin_ws/src/ros_comm/tools/rosbag/include " STREQUAL " ")
  set(rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/home/tim/catkin_ws/src/ros_comm/tools/rosbag/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tim/catkin_ws/src/ros_comm/tools/rosbag/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
