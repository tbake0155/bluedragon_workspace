...
(cl:ensure-generic-function 'azi-val :lambda-list '(m))
(cl:defmethod azi-val ((m <RxmSVSI_SV>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ublox_msgs-msg:azi-val is deprecated.  Use ublox_msgs-msg:azi instead.")
  (azi m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RxmSVSI_SV>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'azi)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 65536) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RxmSVSI_SV>) istream)
  "Deserializes a message object of type '<RxmSVSI_SV>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'azi) (cl:if (cl:< unsigned 32768) unsigned (cl:- unsigned 65536))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RxmSVSI_SV>)))
  ...
  "b58fccf5178b8e0d3921f5737e017cc6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RxmSVSI_SV)))
  "Returns md5sum for a message object of type 'RxmSVSI_SV"
  "b58fccf5178b8e0d3921f5737e017cc6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RxmSVSI_SV>)))
  ...
  (cl:format cl:nil "# see message RxmSVSI~%#~%~%uint8 svid            # Satellite ID~%~%uint8 svFlag          # Information Flags~%uint8 FLAG_URA_MASK = 15      # Figure of Merit (URA) range 0..15~%uint8 FLAG_HEALTHY = 16       # SV healthy flag~%uint8 FLAG_EPH_VAL = 32       # Ephemeris valid~%uint8 FLAG_ALM_VAL = 64       # Almanach valid~%uint8 FLAG_NOT_AVAIL = 128    # SV not available~%~%int16 azi             # Azimuth~%int8 elev             # Elevation~%~%uint8 age             # Age of Almanach and Ephemeris~%uint8 AGE_ALM_MASK = 15       # Age of ALM in days offset by 4~%                              # i.e. the reference time may be in the future:~%                              # ageOfAlm = (age & 0x0f) - 4~%uint8 AGE_EPH_MASK = 240      # Age of EPH in hours offset by 4.~%                              # i.e. the reference time may be in the future:~%                              # ageOfEph = ((age & 0xf0) >> 4) - 4~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RxmSVSI_SV)))
  "Returns full string definition for message of type 'RxmSVSI_SV"
  (cl:format cl:nil "# see message RxmSVSI~%#~%~%uint8 svid            # Satellite ID~%~%uint8 svFlag          # Information Flags~%uint8 FLAG_URA_MASK = 15      # Figure of Merit (URA) range 0..15~%uint8 FLAG_HEALTHY = 16       # SV healthy flag~%uint8 FLAG_EPH_VAL = 32       # Ephemeris valid~%uint8 FLAG_ALM_VAL = 64       # Almanach valid~%uint8 FLAG_NOT_AVAIL = 128    # SV not available~%~%int16 azi             # Azimuth~%int8 elev             # Elevation~%~%uint8 age             # Age of Almanach and Ephemeris~%uint8 AGE_ALM_MASK = 15       # Age of ALM in days offset by 4~%                              # i.e. the reference time may be in the future:~%                              # ageOfAlm = (age & 0x0f) - 4~%uint8 AGE_EPH_MASK = 240      # Age of EPH in hours offset by 4.~%                              # i.e. the reference time may be in the future:~%                              # ageOfEph = ((age & 0xf0) >> 4) - 4~%~%~%"))
