...
(cl:defmethod iTOW-val ((m <RxmRAW>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RxmRAW>)))
  ...
  "1933e39502131517c68160a4906d1675")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RxmRAW)))
  "Returns md5sum for a message object of type 'RxmRAW"
  "1933e39502131517c68160a4906d1675")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RxmRAW>)))
  ...
  (cl:format cl:nil "# RXM-RAW (0x02 0x10)~%# Raw Measurement Data~%#~%# This message contains all information needed to be able to generate a RINEX file.~%#~%~%uint8 CLASS_ID = 2~%uint8 MESSAGE_ID = 16~%~%int32 iTOW              # Measurement integer millisecond GPS time of week (Receiver Time) [ms]~%int16 week              # Measurement GPS week number (Receiver Time) [weeks]~%~%uint8 numSV             # # of satellites following~%uint8 reserved1         # Reserved~%~%RxmRAW_SV[] sv~%~%================================================================================~%MSG: ublox_msgs/RxmRAW_SV~%# see message RxmRAW~%#~%~%float64 cpMes             # Carrier phase measurement [L1 cycles]~%float64 prMes             # Pseudorange measurement [m]~%float32 doMes             # Doppler measurement [Hz]~%~%uint8 sv                  # Space Vehicle Number~%int8 mesQI                # Nav Measurements Quality Indicator~%                          #  >=4 : PR+DO OK~%                          #  >=5 : PR+DO+CP OK~%                          #  <6 : likely loss of carrier lock in previous interval~%int8 cno                  # Signal strength C/No. [dbHz]~%uint8 lli                 # Loss of lock indicator (RINEX definition)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RxmRAW)))
  "Returns full string definition for message of type 'RxmRAW"
  (cl:format cl:nil "# RXM-RAW (0x02 0x10)~%# Raw Measurement Data~%#~%# This message contains all information needed to be able to generate a RINEX file.~%#~%~%uint8 CLASS_ID = 2~%uint8 MESSAGE_ID = 16~%~%int32 iTOW              # Measurement integer millisecond GPS time of week (Receiver Time) [ms]~%int16 week              # Measurement GPS week number (Receiver Time) [weeks]~%~%uint8 numSV             # # of satellites following~%uint8 reserved1         # Reserved~%~%RxmRAW_SV[] sv~%~%================================================================================~%MSG: ublox_msgs/RxmRAW_SV~%# see message RxmRAW~%#~%~%float64 cpMes             # Carrier phase measurement [L1 cycles]~%float64 prMes             # Pseudorange measurement [m]~%float32 doMes             # Doppler measurement [Hz]~%~%uint8 sv                  # Space Vehicle Number~%int8 mesQI                # Nav Measurements Quality Indicator~%                          #  >=4 : PR+DO OK~%                          #  >=5 : PR+DO+CP OK~%                          #  <6 : likely loss of carrier lock in previous interval~%int8 cno                  # Signal strength C/No. [dbHz]~%uint8 lli                 # Loss of lock indicator (RINEX definition)~%~%~%"))
