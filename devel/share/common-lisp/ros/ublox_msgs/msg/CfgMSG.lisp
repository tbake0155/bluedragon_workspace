...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CfgMSG>)))
  ...
  (cl:format cl:nil "# CFG-MSG (0x06 0x01)~%# Message Rate(s)~%#~%~%uint8 CLASS_ID = 6~%uint8 MESSAGE_ID = 1~%~%uint8 msgClass            # Message Class~%uint8 msgID               # Message Identifier~%uint8 rate                # Send rate on current Target~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CfgMSG)))
  "Returns full string definition for message of type 'CfgMSG"
  (cl:format cl:nil "# CFG-MSG (0x06 0x01)~%# Message Rate(s)~%#~%~%uint8 CLASS_ID = 6~%uint8 MESSAGE_ID = 1~%~%uint8 msgClass            # Message Class~%uint8 msgID               # Message Identifier~%uint8 rate                # Send rate on current Target~%~%~%"))
