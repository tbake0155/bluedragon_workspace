...
void rqt_gui_cpp::WaitForMasterThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WaitForMasterThread::master_found_signal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject rqt_gui_cpp::WaitForMasterThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_rqt_gui_cpp__WaitForMasterThread.data,
      qt_meta_data_rqt_gui_cpp__WaitForMasterThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
